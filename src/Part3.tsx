...
const Part3: React.FC = () => {
  ...
  const questions = questionsData.part3;

  useEffect(() => {
    if (mode === "mock" && !isRecording) {
      const timer = setTimeout(() => {
        startRecording(`part3-q${currentQuestion}`);
      }, 1000);
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-2">
              ...
              <h2 className="text-xl font-bold text-gray-800">Part 3</h2>
            </div>
          ...
          <div className="flex items-center justify-center mb-6">
            <RecordingButton
              recordingId={`part3-q${currentQuestion}`}
          ...
          <div className="flex justify-between">
            ...
            >
              <span>
                {currentQuestion < questions.length - 1 ? "Next" : "Summary"}
              </span>
